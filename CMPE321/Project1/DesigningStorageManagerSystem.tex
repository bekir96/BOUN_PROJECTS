...
\textsc{} \\
[270pt]
Date Performed \dotfill 20 July, 2019 \\
...
\textbf{boolean} newPage $\leftarrow$ 0 \\
 ...
 \ForEach{page in RecordFile}{
        \If{page.pageHeader.numberOfRecords \textless 32 or page.isFull == 0}
        {
 ...
 \If{lastPage == 0}
        {
 \ForEach{record in lastPage}{
        \If{record.isEmpty == 1}
        {
        \For{int i=0 to numberOfFields}
            {
